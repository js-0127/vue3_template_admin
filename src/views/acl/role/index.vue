...
import { reqAllRoleList, reqRemoveRole, reqAddOrUpdateRole, reqAllMenuList, reqSetPermisstion } from '@/api/acl/role/index'
...
const getHasRole = async (page: number = 1) => {
  ...
  const res: RoleResponseData = await reqAllRoleList(currentPage.value, limit.value, keyWord.value)
    ...
    <el-dialog :title="title" v-model="dialogTableVisible">
      <el-form :model="roleParams" :rules="rules" ref="form">
        <el-form-item label="角色名称" prop="roleName">
          <el-input placeholder="角色名称" v-model=roleParams.roleName>
          </el-input>
        </el-form-item>
      </el-form>
      <template #footer>
